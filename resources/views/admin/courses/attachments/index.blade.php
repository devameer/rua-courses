        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-5">
                ...
                <div class="card-toolbar">
                    <a href="{{ route('admin.courses.attachments.create', $course) }}" class="btn btn-sm btn-light-primary">
                        ...
                        <tbody>
                            @foreach($course->attachments as $attachment)
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="symbol symbol-50px me-5">
                                                <img src="{{ asset($attachment->image) }}" class="" alt=""/>
                                            </div>
                                    ...
                                    <td>
                                        <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ date('M d, Y' , strtotime($attachment->created_at)) }}</a>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a href="{{ route('admin.courses.attachments.edit',['course' => $course , 'attachment'=> $attachment ] ) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                            {!! theme()->getSvgIcon("icons/duotone/Communication/Write.svg", "svg-icon-3") !!}
                                        </a>

                                        <a href="{{ route('admin.courses.attachments.delete', ['course' => $course , 'attachment'=> $attachment ]) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
