        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    ...
                    <span class="text-muted mt-1 fw-bold fs-7">جميع التصنيفات في الموقع</span>
                </h3>
                <div class="card-toolbar">
                    <a href="{{ route('admin.courses.categories.create') }}" class="btn btn-sm btn-light-primary">
                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <thead>
                            <tr class="fw-bolder text-muted bg-light">
                                <th class="ps-4 min-w-325px rounded-start">التصنيف</th>
                        ...
                        <tbody>
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ date('M d, Y' , strtotime($category->created_at)) }}</a>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a href="{{ route('admin.courses.categories.edit', $category) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                            {!! theme()->getSvgIcon("icons/duotone/Communication/Write.svg", "svg-icon-3") !!}
                                        </a>

                                        <a href="{{ route('admin.courses.categories.delete', $category) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
