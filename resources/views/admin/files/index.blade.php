                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <thead>
                            <tr class="fw-bolder text-muted bg-light">
                                <th class="ps-4 min-w-325px rounded-start">الملف</th>
                        ...
                        <tbody>
                            @foreach($files as $file)
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="symbol symbol-50px me-5">
                                                <img src="{{ asset($file->image) }}" class="" alt=""/>
                                            </div>
                                    ...
                                    <td>
                                        <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ date('M d, Y' , strtotime($file->created_at)) }}</a>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a href="{{ route('admin.files.edit', $file) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                            {!! theme()->getSvgIcon("icons/duotone/Communication/Write.svg", "svg-icon-3") !!}
                                        </a>

                                        <a href="{{ route('admin.files.delete', $file) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
